...
const ProjectsDiv = ({ darkMode, title, description, image, technologies, isNew }) => {
  return (
    <div className="relative md:h-[630px] md:w-[565px] h-[450px] w-[520px] md:px-0 px-4 rounded-3xl md:my-5 overflow-hidden hover:scale-105 transition-transform duration-300 ease-in-out">
      ...
      <img src={image} alt={title} className="md:h-[320px] md:w-[565px] h-[220px] w-[565px] image"  />
      <div className="bg-[#26313F] text-center items-center h-full">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="md:text-xl text-sm text-start mt-2 px-10 text-[#A9A9A9]">{description}</p>
        </div>
