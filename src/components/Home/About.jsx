...
const About = () => {
  return (
    <>
      <div
        id="about"
        className="bg-[#151C25] md:h-screen md:gap-20 px-8 md:px-60 satoshi md:flex md:pt-20 pt-10  justify-center "
      >
        {/* Image */}
        <div className="md:px-0 px-10 ">
          <div className="relative">
            <div className="bg-[#55E5A4] h-64 w-56 md:h-72 md:w-64 rounded-sm"></div>
            <img
